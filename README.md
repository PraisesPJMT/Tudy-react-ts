...
> Tudy is a web application where users can organise their personalised tasks by adding, editing and removing tasks from a list.
...
```sh
  git clone git@github.com:PraisesPJMT/Tudy-react-ts.git
  cd Tudy-react-ts
```
...
> - Original UI design by [Ender Ercedoğan](https://dribbble.com/enderercedogan) on [Dribbble](https://dribbble.com/shots/5796198-Tudy).
